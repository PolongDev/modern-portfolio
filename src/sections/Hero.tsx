    ...
    <section className="h-[90vh] bg-gray-950 flex items-center" id="">
      <div className="text-center">
        ...
        <div className="text-center w-full mt-7 md:mt-10 ">
          <Button className="px-5 bg-white text-gray-900 text-md rounded-full mx-3 font-mono hover:bg-white hover:opacity-90 md:scale-150 md:mx-14">
            <IoDocumentTextOutline className="mr-1 h-4 w-4" />
            Resume
          </Button>
          <Button className="px-5 bg-gray-900 text-white text-md rounded-full mx-3 font-mono md:scale-150 md:mx-14">
